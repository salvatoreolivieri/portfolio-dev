import { _ as _sfc_main$4 } from "./SubHero.272366aa.js";
import { _ as _sfc_main$3 } from "./Markdown.c8386393.js";
...
const philosophy = [
  ...
  {
    subtitle: "The Universe DNA",
    title: "Paradox of complementarity",
    text: `Humans are **diversity** manifestation. **opposing parts that coexis**t within the same casing. **awareness** that wanders in an ecosystem where **order and chaos interact**. Within this game everything is complementary.
  ...
  {
    subtitle: "The wonder of creation",
    title: "The happiness algorithm ",
    text: `So with all these things in mind why i want to put incomprehensible code inside an ide for 8+ hours a day for the rest of my life?
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<ol${ssrRenderAttrs(mergeProps({ class: "relative border-l border-gray-200 dark:border-gray-700 mx-2" }, _attrs))}><!--[-->`);
      ssrRenderList(unref(philosophy), ({ subtitle, title, text }, index2) => {
        _push(`<li class="mb-10 ml-4"><div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div><time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">${ssrInterpolate(subtitle)}</time><div class="relative"><h3 class="text-2xl max-w-max font-semibold text-gray-900 my-2 dark:text-white creative-underline">${ssrInterpolate(title)}</h3></div><div class="w-full md:w-[80%]">`);
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Utility/Timeline.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _sfc_main$1 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_SectionSubHero = _sfc_main$4;
  const _component_UtilityTimeline = _sfc_main$2;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-padded-sm" }, _attrs))}>`);
  _push(ssrRenderComponent(_component_SectionSubHero, {
    title: "My Life Philosophy explained",
    text: "**Who am I** and what is the **meaning of life**? Here you can find **my personal answer** explained following four of my most profound **paradigms** and **thesis**."
  }, null, _parent));
  _push(ssrRenderComponent(_component_UtilityTimeline, null, null, _parent));
  _push(`</div>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Pages/Philosophy.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_PagesPhilosophy = __nuxt_component_0;
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_PagesPhilosophy, null, null, _parent));
  _push(`</div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/philosophy/index.vue");
...
//# sourceMappingURL=index.19de55b7.js.map
